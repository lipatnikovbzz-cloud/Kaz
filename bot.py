...
bot = Bot(token=os.getenv('7593927150:AAHfmWfwnzLRZNkN9pGNznAGgoJZhuVs3to'), default=DefaultBotProperties(parse_mode="HTML"))
dp = Dispatcher()
db = Database()
crypto_pay = CryptoPayAPI(os.getenv('468589:AAULgrXZ8UncNiFlPrRecemO30ylbRoqlTh'))
